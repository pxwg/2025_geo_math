...
\end{equation*}
where $ \mathbb{S}^{1}_{\mathrm{dR}} = \left( \mathbb{S}^{1}, \Omega_{\mathrm{dR}}^{\bullet}(\mathbb{S}^{1}) \right)$ i.e., a $ \mathbb{S}^{1}$ topology with local function ring $ \Omega^{\bullet}_{\mathrm{dR}}(\mathbb{S}^{1})$.
