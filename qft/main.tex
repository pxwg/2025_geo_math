...
However, the highest volume form is not a ideal object to study infinite dimensional integration. The dual of it would be better, which is called the polyvector field
\begin{equation*}
...
\begin{example}[BRST Ghost and Anti-Field Formalism]
  ...
  This BV algebra over $(c^{\alpha}, e_{\alpha})$ is a odd version of the BV algebra over $(x^{i}, \theta_{i})$. Which is associated with the anti-field formalism.
\end{example}
