...
\begin{proof}
  Consider the Chevalley-Eilenberg differential $ \mathrm{d} _{\mathrm{CE}}$ acts on $ a \otimes m$, we have
  \begin{equation*}
    \begin{aligned}
      \mathrm{d} _{\mathrm{CE}}(a\otimes m) = & \mathrm{d} _{\mathrm{CE}} a \otimes m + (-1)^{|a|} a \wedge \mathrm{d} _{\mathrm{CE}} m \\
      = & \frac{1}{2} f^{\alpha}_{\beta \gamma} c^{\beta} c^{\gamma} a_{\alpha} m + (-1)^{|a|} a_{\beta} (\rho^{i}_{j})_{\alpha} v^{j} m_{i} c^{\beta} c^{\alpha}, \\
      \mathrm{d} ^{2}_{\mathrm{CE}}(a \otimes m) = & \frac{1}{2} f^{\alpha}_{\beta \gamma} c^{\beta} c^{\gamma} a_{\alpha} \left( \rho^{i}_{j} \right)_{\rho} c^{\rho} + (-1)^{\left| a \right|}
    \end{aligned}
  \end{equation*}
